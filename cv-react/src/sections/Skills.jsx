      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {skillGroups.map((group, gi) => (
          <motion.div
            ...
            viewport={{ once: true }}
            whileHover={{ y: -2 }}
            className="bg-white border border-blue-100 rounded-xl p-5 shadow-[0_1px_2px_rgba(0,0,0,0.03)] hover:shadow-[0_4px_16px_rgba(59,130,246,0.08)] hover:border-blue-200 transition-all duration-300"
          >
            <h3 className="text-[0.6875rem] font-semibold text-blue-500 uppercase tracking-[0.14em] mb-4 pb-3 border-b border-blue-50">
              {group.category}
            </h3>
              ...
              {group.skills.map(skill => (
                <div key={skill.name} className="flex items-center justify-between group/skill">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-[0.8125rem] font-medium text-gray-700 group-hover/skill:text-gray-900 transition-colors">
                      {skill.name}
                    </span>
                  </div>
